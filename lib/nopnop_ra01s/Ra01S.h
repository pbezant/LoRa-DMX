...
class NopNop_SX126x {
  public:
    NopNop_SX126x(int spiSelect, int reset, int busy, int txen = -1, int rxen = -1);
...
class Ra01S: public NopNop_SX126x {
  public:
    Ra01S(int spiSelect, int reset, int busy, int txen = -1, int rxen = -1);
